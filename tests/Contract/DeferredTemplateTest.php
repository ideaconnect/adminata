 ...
 *
 * This holds three things in agreement: `tests/Contract/deferred-templates.txt`, the
...
final class DeferredTemplateTest extends ContractTestCase
{
    ...
    public function testADeferredTemplateExistsAndSaysSo(string $path): void
    {
        ...
        static::assertFileExists($file, \sprintf(
            ...
            .'tests/Contract/deferred-templates.txt.',
            $path
        ));
    ...
    {
        $lines = file(self::root().'/tests/Contract/deferred-templates.txt', \FILE_IGNORE_NEW_LINES | \FILE_SKIP_EMPTY_LINES);
