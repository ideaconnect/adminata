 ...
 */
#[IgnoreDeprecations]
final class AdminataExtensionTest extends TestCase
{
    private AdminataExtension $twigExtension;
    ...
    protected function setUp(): void
    {
        ...
        $this->twigExtension = new AdminataExtension(new AdminataRuntime($this->pool));
    ...
    public function testGetUrlsafeIdentifier(): void
    {
        ...
        $twigExtension = new AdminataExtension(new AdminataRuntime($pool));
