...
final class InlineConstraintTest extends TestCase
{
    ...
    public function testClosureSerialization(): void
    {
        ...
        // Spelled from the class name so the length prefix cannot drift out of step with it.
        $expected = \sprintf('O:%d:"%s":0:{}', \strlen(InlineConstraint::class), InlineConstraint::class);
