...
export default {
    // Generated by bin/build-css-safelist.mjs.
    ignoreFiles: ['assets/css/safelist.css'],
    ...
    rules: {
        ...
        // `@utility` is a scoping root Stylelint does not know, so `&:hover` inside one looks
        // unscoped to it.
        'nesting-selector-no-missing-scoping-root': null,
        // BEM element names inside the `.adm-*` layer: `.adm-alert__body` belongs to `.adm-alert`.
