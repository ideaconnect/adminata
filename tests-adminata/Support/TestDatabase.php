 ...
 * server with `ADMINATA_TEST_DATABASE_URL` (the bundle's suite) or `ADMINATA_DEMO_DATABASE_URL`
 * (the demo application); the database name in that URL is replaced per suite, so one server
 * serves them all.
 *
