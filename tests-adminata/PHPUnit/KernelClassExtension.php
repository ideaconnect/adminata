 ...
 * `KERNEL_CLASS` environment variable. adminata runs what is left of them from one
 * configuration file against three different test kernels — the admin bundle's, the small
 * Doctrine-only one beside it, and the demo application adminata's own suites drive — so the
 * variable has to follow the test class instead of being global. Doing it here keeps the
