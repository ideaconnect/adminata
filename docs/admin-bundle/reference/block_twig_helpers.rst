...
adminata provides several Twig helper functions to allow easier interaction with blocks. Their names are Sonata's, unchanged:
...
.. note::
    ...
    Review the `Events` section for more information: :doc:`block_events`
