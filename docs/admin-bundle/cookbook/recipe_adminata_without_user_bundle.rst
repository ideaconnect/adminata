Adminata without SonataUserBundle
====================================

Here we will explain how you can use Adminata with Symfony Guard instead
...
- `Login template resembling Sonata style <#login-template-resembling-adminata-style>`__
...
more about it `here <https://symfony.com/doc/5.4/security/guard_authentication.html#step-2-create-the-authenticator-class>`__::
    ...
    final class AdminLoginAuthenticator extends AbstractFormLoginAuthenticator implements AuthenticatorInterface
    {
        ...
        {
            return new RedirectResponse($this->router->generate('adminata_dashboard'));
        }
    }
...
.. code-block:: yaml
    ...
    access_control:
        ...
        - { path: ^/admin/, role: [ROLE_ADMIN, ROLE_ADMINATA_ADMIN] }
...
.. code-block:: html+twig
    ...
    {% block body_attributes %}class="adminata-bc login-page"{% endblock %}

    {% block adminata_wrapper %}
        <div class="login-box">
            <div class="login-logo">
                <a href="{{ path('adminata_dashboard') }}">
                    <span>Login</span>
                </a>
            </div>
