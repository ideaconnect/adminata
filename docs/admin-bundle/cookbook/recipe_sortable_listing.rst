...
A sortable behavior is already available for one-to-many relationships (https://github.com/ideaconnect/adminata-doctrine-orm-admin-bundle/blob/main/docs/reference/form_field_definition.rst#advanced-usage-one-to-many).
