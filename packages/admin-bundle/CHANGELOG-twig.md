...
> **adminata note.** This is `sonata-project/twig-extensions`'s own changelog, up to the imported
> tag 2.6.0. The bundle was merged into this package directory on 2026-09-06 — its classes are
> `Sonata\AdminBundle\` now and there is no `SonataTwigBundle` — so its changelog sits beside the
