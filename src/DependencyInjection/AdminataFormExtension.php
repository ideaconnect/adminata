 ...
 */
final class AdminataFormExtension extends Extension implements PrependExtensionInterface
{
    /**
     * Takes "adminata.options.form_type" as the default of this root's own "form_type" and adds
     * the datepicker widget to the form themes.
     */
    public function prepend(ContainerBuilder $container): void
    {
        $configs = $container->getExtensionConfig('adminata');
    ...
    public function getConfiguration(array $config, ContainerBuilder $container): ConfigurationInterface
    {
        ...
        // which is the "adminata_admin" root's tree.
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('adminata.form.form_type', $config['form_type']);
    }
}
