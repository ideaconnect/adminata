 ...
 */
abstract class AbstractAdminataExtension extends Extension
{
    /**
     * @param array<string, mixed> $configs
     * @param array<string, mixed> $defaultAdminataDoctrineConfig
     *
     * @return mixed[]
     */
    protected function fixTemplatesConfiguration(
        ...
        array $defaultAdminataDoctrineConfig = [],
    ): array {
        $defaultConfig = [
            'templates' => [
                'types' => [
        ...
        if ([] !== $defaultAdminataDoctrineConfig) {
            $defaultConfig = array_merge_recursive($defaultConfig, $defaultAdminataDoctrineConfig);
        }
