...
final class SonataBlockExtension extends Extension
{
    ...
    public function getConfiguration(array $config, ContainerBuilder $container): ConfigurationInterface
    {
        ...
        if (isset($bundles['SonataPageBundle'])) {
            ...
            $defaultTemplates['SonataAdminBundle default template'] = '@SonataAdmin/Block/block_container.html.twig';
        }
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        if (null === $config['templates']['block_base']) {
            if (isset($bundles['SonataPageBundle'])) {
                ...
                $config['templates']['block_base'] = '@SonataAdmin/Block/block_base.html.twig';
                $config['templates']['block_container'] = '@SonataAdmin/Block/block_container.html.twig';
            }
        }
