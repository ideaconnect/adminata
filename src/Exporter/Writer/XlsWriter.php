...
final class XlsWriter implements TypedWriterInterface
{
    ...
    public function open(): void
    {
        ...
        $this->file = $file;
        fwrite($this->file, '<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name=ProgId content=Excel.Sheet><meta name=Generator content="https://github.com/ideaconnect/adminata"></head><body><table>');
    }
